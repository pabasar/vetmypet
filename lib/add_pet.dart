...
class AddPetState extends State<AddPet>
{
  ...
  void handleRadioGender(int value)
  {
    setState(() {
      radioValueGender = value;

      switch(radioValueGender)
      {
        case 0:
        //_finalResult = calculateWeight(_weightController.text, 0.06);
          _maleFemale = "Yes";
                          ...
                          new Container(
                            ...
                            child: new ListView(
                              children: <Widget>[
                                ...
                                SizedBox(height: 4.0),
                                new Text("Cat",
                                  style: new TextStyle(color: Colors.grey[800]),textAlign: TextAlign.center,),
                              ],
                  ...
                  new Row(
                    ...
                    children: <Widget>[
                      ...
                      new Radio<int>(
                          ...
                          value: 0, groupValue: radioValueGender, onChanged: handleRadioGender),

                      new Text(
                        "Male",style: new TextStyle(color: Colors.black),
                      ),
                      ...
                      new Radio<int>(
                          activeColor: Color(0xFFe25d5b),
                          value: 1, groupValue: radioValueGender, onChanged: handleRadioGender),

                      new Text(
                        "Female",style: new TextStyle(color: Colors.black),
                      ),
                    ],
                  ),
                  SizedBox(height: 20.0),
